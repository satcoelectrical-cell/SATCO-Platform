...
class Settings(BaseSettings):
    ...
    GUIDANCE_ENHANCEMENT_EGRESS_ENABLED: bool = False
    GUIDANCE_ENHANCEMENT_PROVIDER_ENDPOINT: str = ""
    GUIDANCE_ENHANCEMENT_PROVIDER_API_KEY: str = ""
    GUIDANCE_ENHANCEMENT_TIMEOUT_SECONDS: float = 30.0
    CROSS_DISCIPLINE_AI_ENABLED: bool = False
