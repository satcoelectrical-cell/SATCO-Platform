...
class CrossDisciplineSourceReader(Protocol):
    def acquire(self, *, authorized, definition, interface_ids: tuple[str, ...], selectors: tuple[str, ...], purpose: str, combination_id: str, project_change_id: UUID | None, project_change_version: int | None, execution_id: UUID, snapshot_id: UUID, registry_digest: str, workspace_bindings: tuple[tuple[int, str, int], ...], observed_at: datetime): ...
