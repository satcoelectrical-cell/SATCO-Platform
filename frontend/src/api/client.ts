...
import type { EffectiveDisciplinePackages, OrganizationPackageConfiguration, ProjectPackageConfiguration, SupportedPackages, WorkspacePackageApplicability } from "./types";
